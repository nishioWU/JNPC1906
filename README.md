...
終了後にアップロードしたフォルダが２つあります。フォルダ名に「NEW」がついているものです。これ以外は、データフォルダも含め、当日のままですので、NEW以外はダウンロードし直さなくて結構です。graphフォルダに、ハンズオンで作った07年参院選の投票率の散布図をHTML版にしたものがあります。点にカーソルを重ねると、県名や07年と04年の投票率、変化幅を表示します。Plotlyを使いました。  
